...
const WalletPage = () => {
  ...
  const mockTransactions = [
    { id: 1, type: 'topup', amount: 500, description: 'Wallet Top-up via GCash', createdAt: new Date().toISOString(), referenceId: 'topup_001' },
    { id: 2, type: 'order', amount: -150, description: 'Order at BGC Branch', createdAt: new Date(Date.now() - 86400000).toISOString(), referenceId: 'order_001' },
  ];
  ...
  if (loading) {
    return (
      <div className="wallet-page-wrapper d-flex justify-content-center align-items-center" style={{ minHeight: '80vh' }}>
            ...
            <div className="balance-card shadow-sm">
              <div className="balance-header">
                <span className="logo-text">
                  <img src="/kapebara-logo-2.png" alt="Kapebara" className="label-logo" /> Wallet
                </span>
              </div>
