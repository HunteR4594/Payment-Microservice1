...
const VoucherHistoryPopup = ({ 
  ...
  const displayVouchers = vouchers && vouchers.length > 0 ? vouchers : [
    { id: 1, name: 'Free Delivery', minSpend: 200, usedOn: { date: '01/05/2026', location: 'SM North Edsa' } },
    { id: 2, name: '10% Off', minSpend: 500, usedOn: { date: '12/28/2025', location: 'BGC High Street' } }
  ];
    ...
    <div className="voucher-history-overlay" onClick={onClose}>
      <div className="voucher-history-container" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="voucher-history-header">
          <button className="voucher-back-button" onClick={onClose}>
          ...
          <div className="voucher-history-top">
            <div className="voucher-banner">
              ...
              <div className="banner-info">
                ...
                <p className="voucher-sub">Min. Spend of ₱{currentVoucher.minSpend || currentVoucher.MinSpend || '0'}</p>
              </div>
            </div>
            ...
            >
              ...
              <div className="voucher-card-content">
                ...
                <div className="voucher-banner small">
                  ...
                  <div className="banner-info">
                    <p className="voucher-name">{voucher.name || voucher.Name}</p>
                    <p className="voucher-sub">Min. Spend of ₱{voucher.minSpend || voucher.MinSpend || '0'}</p>
                  </div>
                </div>
              </div>
            </div>
