            ...
            <div key={voucher.id} className="voucher-card">
              ...
              <div className="voucher-right">
                ...
                <div className="voucher-details">
                  <span>Min. order: {voucher.minOrderAmount > 0 ? `₱${voucher.minOrderAmount}` : 'None'}</span>
                  <span>Expires: {voucher.expiresAt ? new Date(voucher.expiresAt).toLocaleDateString() : 'No Expiry'}</span>
                </div>
