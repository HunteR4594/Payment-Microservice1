...
public class MockTopUpService : ITopUpService
{
    private readonly Dictionary<string, TopUp> _topUps = new();
    private readonly IWalletService _walletService;
    private readonly IPaymentProvider _paymentProvider;
    private readonly ILogger<MockTopUpService> _logger;

    public MockTopUpService(IWalletService walletService, IPaymentProvider paymentProvider, ILogger<MockTopUpService> logger)
    {
    ...
    public async Task<TopUp> CompleteTopUpAsync(string topUpId)
    {
        ...
        await _walletService.AddBalanceAsync(
            topUp.UserId, 
            topUp.Amount, 
            topUp.Id,  // Pass the top-up ID as reference
